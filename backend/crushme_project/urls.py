...
from crushme_project.health import health_check
...
urlpatterns = [
    ...
    re_path(
        r"^en/products/category/(?P<category>[\w-]+)/$",
        FrontendView.as_view(),
        name="products-by-category-en",
    ),
    re_path(
        r"^es/products/category/(?P<category>[\w-]+)/$",
        FrontendView.as_view(),
        name="products-by-category-es",
    ),
    re_path(
        r"^en/products/(?P<id>\d+)/$", FrontendView.as_view(), name="product-detail-en"
    ),
    re_path(
        r"^es/products/(?P<id>\d+)/$", FrontendView.as_view(), name="product-detail-es"
    ),
    ...
    re_path(
        r"^en/diaries/@(?P<username>[\w.@+-]+)/$",
        FrontendView.as_view(),
        name="diaries-user-en",
    ),
    re_path(
        r"^es/diaries/@(?P<username>[\w.@+-]+)/$",
        FrontendView.as_view(),
        name="diaries-user-es",
    ),
    # Wishlist direct checkout routes (with and without language prefix)
    re_path(
        r"^@(?P<username>[\w.@+-]+)/(?P<wishlist_id>\d+)/$",
        FrontendView.as_view(),
        name="wishlist-checkout",
    ),
    re_path(
        r"^en/@(?P<username>[\w.@+-]+)/(?P<wishlist_id>\d+)/$",
        FrontendView.as_view(),
        name="wishlist-checkout-en",
    ),
    re_path(
        r"^es/@(?P<username>[\w.@+-]+)/(?P<wishlist_id>\d+)/$",
        FrontendView.as_view(),
        name="wishlist-checkout-es",
    ),
]
