    ...
    <div class="promo-banner">
      ...
      <div class="banner-content">
        ...
        <div class="text-section">
          <h3 
            v-if="title" 
            class="font-comfortaa text-brand-dark text-2xl md:text-3xl font-bold mb-4"
          >
            {{ title }}
          </h3>
          
          <p 
            class="font-poppins text-lg md:text-xl leading-relaxed mb-8"
            :class="{ 'mt-0': !title, 'pt-2': !title }"
          ...
          <!-- Buttons -->
          <div class="buttons-section flex flex-col sm:flex-row gap-3">
            <button 
              v-if="primaryButton"
...
.btn-primary {
  ...
  font-weight: 600;
  padding: 0.875rem 2rem; /* Botones más largos */
