      ...
      <div class="signup-card">
        ...
        <form @submit.prevent="handleSignup" class="signup-form">
          ...
          <div class="password-requirements">
            <p class="requirements-title">{{ $t('signup.passwordRequirements.title') }}</p>
            <ul class="requirements-list">
              <li>{{ $t('signup.passwordRequirements.minLength') }}</li>
              <li>{{ $t('signup.passwordRequirements.uppercase') }}</li>
              <li>{{ $t('signup.passwordRequirements.lowercase') }}</li>
              <li>{{ $t('signup.passwordRequirements.number') }}</li>
              <li>{{ $t('signup.passwordRequirements.special') }}</li>
            </ul>
          </div>
