<template>
  ...
  <!-- Floating WhatsApp button with neon glow (solo español) -->
  <a
    v-if="!loading && !showPreloader && i18nStore.locale === 'es'"
    href="https://wa.me/573239397946"
    target="_blank"
...
// Variables para compatibilidad (si se usan en algún lugar)
const loading = false
